                ...
                <div className="text-center z-10 px-4 flex flex-col items-center">
                    ...
                    <div className="mb-8 w-full flex justify-center">
                        <img 
                            src={image}  
                            alt="Claire Nguyen" 
                            className="w-[200px] h-[200px] sm:w-[250px] sm:h-[250px] md:w-[280px] md:h-[280px] object-cover rounded-full shadow-xl shadow-gray-900 transition-all duration-300 hover:-translate-y-2 hover:scale-105 hover:shadow-2xl hover:shadow-gray-600"
                        />
                    </div>
